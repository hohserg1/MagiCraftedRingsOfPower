package hohserg.mcrop.hooklib.asm;
...
public class AsmHook implements Cloneable, Comparable<AsmHook> {
    ...
    protected boolean isTargetMethod(String name, String desc) {
        if (name.equals("writeRecipeAndDataToBook") || name.equals("createSpellStack"))
            System.out.println();
        return (targetMethodReturnType == null && desc.startsWith(targetMethodDescription) || desc.equals(targetMethodDescription))
    ...
    public class Builder extends AsmHook {
         ...
         * import static hohserg.mcrop.hooklib.asm.TypeHelper.*
         * //...
